...
/* harmony import */ var _Public_css_indexUser_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(17);
/* harmony import */ var _Public_css_indexUser_scss__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_Public_css_indexUser_scss__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _navPopover__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(18);
/* harmony import */ var _CheckLogin__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(33);
/* harmony import */ var _CheckLogin__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_CheckLogin__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _CoursePage__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(216);
// Bootstrap + jquery 
...
/* harmony import */ var _ServiceKhoaHoc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _Models_HinhAnh__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
var serviceKhoaHoc = new _ServiceKhoaHoc__WEBPACK_IMPORTED_MODULE_1__[/* ServiceKhoaHoc */ "a"]();
var MangDSKHdaGD = [];
var user = [];
Object(_const_data__WEBPACK_IMPORTED_MODULE_3__["createData"])();
getStorage(); // ThongTinGhiDanhKhoaHoc();
...
function ThongTinGhiDanhKhoaHoc() {
  ...
  if (jsonUser != null) {
    ...
    user = kq;
    var dskhdk = serviceKhoaHoc.LayThongTinGhiDanhKhoaHoc(dskh, user.TaiKhoan); //AnDanhSachGhiDanh();
  }
...
function TimKiemKhoaHoc() {
  ...
  var list = dskh.TimKiemKhoaHoc(name); //AnDanhSachGhiDanh();
...
function loadList(list) {
  ...
  for (var i = 0; i < list.mangKhoaHoc.length; i++) {
    for (var j = 0; j < dsha.mangHinhAnh.length; j++) {
      if (list.mangKhoaHoc[i].MaKhoaHoc == dsha.mangHinhAnh[j].ten) {
        var divcol;
        var li;
        var theA;
        var divCard;
        ...
        (function () {
          var value = list.mangKhoaHoc[i]; //col-md-3

          divcol = document.createElement('div');
          divcol.className = "col-md-4 col-6";
          divcol.id = value.MaKhoaHoc; //Li Course
          ...
          theImg.setAttribute('src', dsha.mangHinhAnh[j].src); //card body
...
function setAnh() {
  ...
  if (json == null || json == undefined) {
    for (var i = 0; i < dskh.mangKhoaHoc.length; i++) {
      ...
      var src = HinhAnh();
      var img = new _Models_HinhAnh__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](ten, src);
    ...
    if (kqdsha != kqdskh) {
      ...
      for (var _i = 0; _i < dskh.mangKhoaHoc.length; _i++) {
        ...
        var src1 = HinhAnh();
        var img1 = new _Models_HinhAnh__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](ten1, src1);
...
function getStorage() {
  dskh.mangKhoaHoc = Object(_const_data__WEBPACK_IMPORTED_MODULE_3__["getData"])('dskh');
  setAnh();
  loadList(dskh);
} //  load more
...
loadMore(); // remove margin-top item hidden

function checkRemove() {
  var myDiv = $('#loadList > div');

  for (var i = 0; i <= myDiv.length; i++) {
    var heightDiv = $(myDiv[i]).height();
