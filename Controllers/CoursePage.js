...
import { createData, getData } from '../const/data';
...
{   
    ...
    if(jsonUser != null)
    {
        ...
        const dskhdk = serviceKhoaHoc.LayThongTinGhiDanhKhoaHoc(dskh,user.TaiKhoan);
...
function loadList(list)
{
    ...
    ul.innerHTML = "";
    for(let i = 0; i < list.mangKhoaHoc.length; i++)
    {
